...
class Node:
    ...
    def update(self, a, delta):
        ...
        self.cmd_vel_pub.publish(Float64(0.5))
    ...
    def run(self, ref_path, target_speed):
        ...
        while t < max_time:
            ...
            if dist <= C.dref and c > 100:
                self.brakes.publish(Float64(0.2))
            ...
            plt.plot(ref_path.cx[target_index], ref_path.cy[target_index], '.r')
...
def main():
    ...
    with open('/home/egyptianego17/Desktop/EVER/MotionPlanning/Control/circle_coordinates (1).csv', newline='') as f:
