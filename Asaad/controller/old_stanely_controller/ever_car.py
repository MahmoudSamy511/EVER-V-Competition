...
class Path:
    ...
    def __init__(self):
        ...
        with open('circle_coordinates.csv', newline='') as f:
...
def main():
    ...
    rospy.loginfo('Here I\'m 1')
    plt.grid()
    plt.show()
    rospy.loginfo('Here I\'m 2')
...
if __name__ == '__main__':
    ...
    for _ in range(50):
        brakes_pub.publish(Float64(0.35))
        rate.sleep()

    # Stop the car completely
    brakes_pub.publish(Float64(0.5))  
    cmd_vel_pub.publish(Float64(0.0))
    rospy.loginfo('Here I\'m 3')
