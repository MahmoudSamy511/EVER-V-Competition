...
class OdomImuLogger:
    ...
    def odom_callback(self, msg):
        ...
        odom_values = [msg.header.stamp.to_sec(), msg.pose.pose.position.x, msg.pose.pose.position.y, msg.pose.pose.position.z]
        self.odom_data.append(odom_values)


    def imu_callback(self, msg):
        # Process and store IMU data
        imu_values = [msg.header.stamp.to_sec(), msg.orientation.x, msg.orientation.y, msg.orientation.z, msg.angular_velocity.x, msg.angular_velocity.y, msg.angular_velocity.z]
...
def main():
    ...
    rospy.spin()  # Keep the program from exiting until shutdown signal is received
    logger.save_to_csv()
